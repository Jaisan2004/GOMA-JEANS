...
const routes: Routes = [
  ...
  { path: 'hombre', loadChildren: () => import('./modules/hombre/hombre.module').then(m => m.HombreModule) },
  { path: 'mujer', loadChildren: () => import('./modules/mujer/mujer.module').then(m => m.MujerModule) },
